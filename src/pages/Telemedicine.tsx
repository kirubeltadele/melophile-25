...
const consultants = [
  {
    id: "1",
    name: "Dr. Yonas Baheretibeb Alemu",
    specialty: "Culture and Psychiatry, Community Psychiatry, Child and Adolescent Psychiatry",
    rating: 4.8,
    reviewCount: 124,
    yearsExperience: 12,
    availability: "Available Today",
    imageUrl: "/1consultant.jpg",
  },
  {
    id: "2",
    name: "Dr. Moges G/Mariam",
    specialty: " Counseling Psychology, Positive and Cross-Cultural Psychotherapy",
    rating: 4.9,
    reviewCount: 89,
    yearsExperience: 8,
    availability: "Available Tomorrow",
    imageUrl: "/2consultant.jpg",
  },
  {
    id: "3",
    name: "Dr. Brook alemayehu",
    specialty: "Dietary Consultant",
    rating: 4.7,
    reviewCount: 56,
    yearsExperience: 5,
    availability: "Available Today",
    imageUrl: "/3consultant.jpg",
  },
  {
    id: "4",
